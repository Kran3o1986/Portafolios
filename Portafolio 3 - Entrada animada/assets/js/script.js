...
/*function toggleDiv(event, divId) {
    event.preventDefault(); // Evitar que se abra una nueva pestaña o se recargue la página
    ...
    // Obtener el contenido correspondiente al div seleccionado
    var content = getContent(divId);

    // Mostrar el contenido en la columna "contenido"
    var contenidoDiv = document.getElementById('contenido');
    contenidoDiv.innerHTML = content;
}
